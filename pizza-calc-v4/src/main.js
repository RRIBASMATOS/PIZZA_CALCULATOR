...
$('style').onchange=()=>{updateSubs();calc()};$('substyle').onchange=()=>{updateFermPresets();calc()};$('fermPreset').onchange=()=>{applyFermPreset();calc()};$('flourPreset').onchange=()=>{applyFlour();calc()};$('calc').onclick=calc;fill();calc();
